...
module Memory1R1WUndefined(	// <stdin>:3:10
...
module mem(	// src/main/scala/Memory.scala:61:24
  input  [4:0]  R0_addr,
  input         R0_clk,
  input  [4:0]  W0_addr,
  input         W0_clk,
  ...
  mem_ext mem_ext (	// src/main/scala/Memory.scala:61:24
    .R0_addr (R0_addr),
    .R0_en   (1'h1),
    .R0_clk  (R0_clk),
    .W0_addr (W0_addr),
...
[
  {
    ...
    "extra_ports": [],
    "hierarchy": [
      "Memory1R1WUndefined.mem.mem_ext"
    ]
  }
]
...
// ----- 8< ----- FILE "Memory1R1WUndefined_firtool.conf" ----- 8< -----
