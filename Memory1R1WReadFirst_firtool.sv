...
module Memory1R1WReadFirst(	// <stdin>:3:10
  ...
  mem mem (	// src/main/scala/Memory.scala:27:24
    .R0_addr (raddr),
    .R0_clk  (clock),
    .W0_addr (waddr),
    .W0_clk  (clock),
...
module mem(	// src/main/scala/Memory.scala:27:24
  input  [4:0]  R0_addr,
  input         R0_clk,
  input  [4:0]  W0_addr,
  input         W0_clk,
  ...
  mem_ext mem_ext (	// src/main/scala/Memory.scala:27:24
    .R0_addr (R0_addr),
    .R0_en   (1'h1),
    .R0_clk  (R0_clk),
    .W0_addr (W0_addr),
...
[
  {
    ...
    "extra_ports": [],
    "hierarchy": [
      "Memory1R1WReadFirst.mem.mem_ext"
    ]
  }
]
...
// ----- 8< ----- FILE "Memory1R1WReadFirst_firtool.conf" ----- 8< -----
